...
if __name__ == "__main__":
    ...
    # EXAMPLE 1: Corrective-RAG, Adaptive-RAG
    print(graph.invoke(
        input={"question": "what is agent memory?"} # all relevant, route to vectorstore
    ))

    # EXAMPLE 2: Corrective-RAG, Adaptive-RAG
    # print(
    #     graph.invoke(
    #         input={"question": "what is AGI?"}  # all irrelevant, route to web search
    #     )
    # )

    # EXAMPLE 3: Corrective-RAG
    # print(
